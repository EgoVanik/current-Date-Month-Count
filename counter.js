...
document.addEventListener('DOMContentLoaded', () => {
    function counter(cSelector, dateSelector, monthSelector) {
        let counterSelector = document.querySelector(cSelector),// селектор кол-ва штук
            currentDateSelector = document.querySelector(dateSelector),// селектор текущего дня
            currentMonthSelector = document.querySelector(monthSelector),// селектор месяца
    ...
    // для вызова
    counter('#myCounter','#currentDate', '#currentMonth');
});
